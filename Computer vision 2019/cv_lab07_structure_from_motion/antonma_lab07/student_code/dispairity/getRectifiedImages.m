...
% imgLgray = cat(3, imgL, imgL, imgL);
% imgRgray = cat(3, imgR, imgR, imgR);
% imgLgray = rgb2gray(imgLgray);
% imgRgray = rgb2gray(imgRgray);
imgLgray = imgL;
imgRgray = imgR;
% extract features
...
% compute F
[F, inliers] = fundamentalMatrixRANSAC(x1s(:, matches(1,:)), x2s(:, matches(2,:)), 0.5);
